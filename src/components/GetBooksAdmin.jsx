          ...
          {books?.map((book, i) => (
            <tr key={book.id}>
                ...
                <tr>
                    <td>
                    <td className='array'>
                    <button onClick={() => togglePopUpEdit(i)}>Redigera</button>
                    ...
                    <td className='array'>
                    <button onClick={() => togglePopUpDeleteBook(i)}> Ta bort</button> 
                    ...
                    <td className='array'>
                    <button onClick={() => togglePopUpPurgeBook(i)}>Radera</button> 
